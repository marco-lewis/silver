...
check("bv_fixed6.json", "fixed_bv", z3.unsat, timeout=60000)
check("bv_fixed7.json", "fixed_bv", z3.unsat, timeout=60000)
check("bv_fixed8.json", "fixed_bv", z3.unsat, timeout=60000)