; modified benchmark generated from python API
...
(assert
 (=> (= Pr_x_v7_0 0.0) (not (= meas_x 0))))
(assert
 (=> (= Pr_x_v7_1 0.0) (and (not (= meas_x 1)) true)))
(assert
 (=> (= Pr_x_v7_2 0.0) (and (not (= meas_x 2)) true)))
(assert
 (=> (= Pr_x_v7_3 0.0) (and (not (= meas_x 3)) true)))
(assert
 true)
(assert
(= x_v0c meas_x))
...
(assert
 (and (or (= f_0 0) (= f_0 1)) (or (= f_1 0) (= f_1 1)) (or (= f_2 0) (= f_2 1)) (or (= f_3 0) (= f_3 1))))
(assert
